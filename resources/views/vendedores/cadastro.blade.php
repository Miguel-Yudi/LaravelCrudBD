...
<body>
    ...
    <section class="vendedores">
      ...
      <div class="form-section">
        ...
        <form action="{{ route('vendedores.store') }}" method="POST" class="Vendedor">
        @csrf

              <div class="campo">
                <label for="nome">Nome:</label>
                <input type="text" id="nome" name="nome_vend">
              </div>

              <div class="campo">
                <label for="nome">Id Região:</label>
                <input type="number" id="nome" name="id_reg">
              </div>

              <div class="campo">
                <label for="endereco">Endereço:</label>
                <input type="text" id="endereco" name="endereco_vend">
              </div>

              <div class="campo">
                <label for="nasc">Nascimento:</label>
                <input type="date" id="nasc" name="nasc_vend">
              </div>

              <div class="campo">
                <label for="email">Email:</label>
                <input type="text" id="email" name="email_vend">
              </div>

              <div class="campo">
                <label for="tel">Telefone:</label>
                <input type="text" id="tel" name="tel_vend">
              </div>
            ...
            <button type="submit" class="btn-procurar">Cadastrar</button>
        </form>

        <!-- link para a outra página de cadastro -->
        <a href="/vendedores" class="link-procurar">Vendedor já existe?</a>
      </div>
    </section>
  </main>
